...
// generate all kinds of int types
...
// get random int values from the generator
...
// get float with n digits of int and f for digits of fraction
...
// get legal time from 1970 to 2038
...
// add backslash to special chars like ", ', \
